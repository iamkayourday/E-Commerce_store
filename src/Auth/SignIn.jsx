  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6">
      <div className="p-6 w-full max-w-md">
        ...
        <p className="text-gray-600 text-center mt-6 mb-6">Hi, welcome back! You've been missed.</p>
        ...
        <form className="mt-6" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end mb-4">
            <a href="#" className="text-[#704f38] text-sm font-medium hover:underline">
              Forgot password?
            </a>
          </div>
        ...
        <p className="text-center text-gray-700 mt-6">
          ...
          <Link to="/sign-up" className="text-[#704f38] font-medium hover:underline">
            Sign Up
          </Link>
        </p>
      </div>
